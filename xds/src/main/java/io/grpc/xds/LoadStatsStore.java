 ...
 * cluster:cluster_service exposed by management server from a gRPC client's perspective,
 ...
 *
 * <p>An {@code LoadStatsStore} only tracks loads for localities exposed by management server.
 *
